...
namespace Game
{
    ...
    public class Game_Othello_Board
    {
        ...
        // valid.
        //
        public List<ArrayList> MakeMove(int color, int row, int col)
        {
            List<ArrayList> flippedPieces = new List<ArrayList>();
            ArrayList xFlip = new ArrayList();
            ArrayList yFlip = new ArrayList();
            flippedPieces.Add(xFlip);
            flippedPieces.Add(yFlip);
